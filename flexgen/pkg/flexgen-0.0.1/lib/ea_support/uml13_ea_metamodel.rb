...
class UML13EA::Expression < FlexGen::MetamodelBuilder::MMBase
...
class UML13EA::Element < FlexGen::MetamodelBuilder::MMBase
end
...
class UML13EA::Classifier < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::GeneralizableElement, UML13EA::Namespace)
end
...
class UML13EA::Call < FlexGen::MetamodelBuilder::MMBase
end
...
class UML13EA::XmiIdProvider < FlexGen::MetamodelBuilder::MMBase
end

class UML13EA::StateVertex < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::ModelElement, UML13EA::XmiIdProvider)
end
...
class UML13EA::Association < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::GeneralizableElement, UML13EA::Relationship, UML13EA::XmiIdProvider)
end
...
class UML13EA::MultiplicityRange < FlexGen::MetamodelBuilder::MMBase
...
class UML13EA::Class < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::Classifier, UML13EA::XmiIdProvider)
...
class UML13EA::Package < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::Namespace, UML13EA::GeneralizableElement, UML13EA::XmiIdProvider)
end
...
class UML13EA::LinkObject < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::Link, UML13EA::Object)
end
...
class UML13EA::AssociationEnd < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::ModelElement, UML13EA::XmiIdProvider)
...
class UML13EA::TemplateParameter < FlexGen::MetamodelBuilder::MMBase
end
...
class UML13EA::Generalization < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::Relationship, UML13EA::XmiIdProvider)
...
class UML13EA::Subsystem < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::Package, UML13EA::Classifier)
...
class UML13EA::ElementResidence < FlexGen::MetamodelBuilder::MMBase
   has_attr 'visibility', UML13EA::VisibilityKind, :defaultValueLiteral => "public" 
end
...
class UML13EA::AssociationClass < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::Class, UML13EA::Association)
end

class UML13EA::Node < UML13EA::Classifier
end

class UML13EA::ElementImport < FlexGen::MetamodelBuilder::MMBase
   has_attr 'visibility', UML13EA::VisibilityKind, :defaultValueLiteral => "public" 
...
class UML13EA::Collaboration < FlexGen::MetamodelBuilder::MMMultiple(UML13EA::GeneralizableElement, UML13EA::Namespace)
end
...
class UML13EA::EnumerationLiteral < FlexGen::MetamodelBuilder::MMBase
   has_attr 'name', String 
end
...
class UML13EA::Multiplicity < FlexGen::MetamodelBuilder::MMBase
end
...
class UML13EA::ActionInstance < FlexGen::MetamodelBuilder::MMBase
end
