...
require 'flexgen/metamodel_builder/builder_runtime'
require 'flexgen/metamodel_builder/builder_extensions'
require 'flexgen/metamodel_builder/module_extension'
require 'flexgen/metamodel_builder/data_types'
require 'flexgen/metamodel_builder/mm_multiple'
...
module MetamodelBuilder	
	...
	class MMBase
		...
		extend FlexGen::ECore::ECoreInstantiator
