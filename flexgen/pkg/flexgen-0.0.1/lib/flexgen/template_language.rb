...
require 'flexgen/template_language/directory_template_container'
require 'flexgen/template_language/template_container'

module FlexGen

# The FlexGen template language has been designed to build complex generators.
...
# 
# Template files used by the FlexGen template language should have a 
...
# See FlexGen::TemplateLanguage::TemplateContainer for details about the syntax of +define+.
# 
...
# 
# The FlexGen template language has been design for generators which do not need a
...
# The FlexGen template language facilitates this by means of the +file+ keyword.
# 
...
#
#   module MyMM
#     # metaclasses are defined here, e.g. using FlexGen::MetamodelBuilder
#   end
# 
#   OUTPUT_DIR = File.dirname(__FILE__)+"/output"
#   TEMPLATES_DIR = File.dirname(__FILE__)+"/templates"
# 
#   tc = FlexGen::TemplateLanguage::DirectoryTemplateContainer.new(MyMM, OUTPUT_DIR)
