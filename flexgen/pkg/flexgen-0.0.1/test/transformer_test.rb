...
class TransformerTest < Test::Unit::TestCase
	...
	class MyTransformer < FlexGen::Transformer
	...
	class MyTransformer2 < FlexGen::Transformer
	...
	def test_transformer
		from = ModelIn.new
		from.name = "TestName"
		env_out = FlexGen::Environment.new
  ...
  def test_transformer_chain
	...
	class CopyTransformer < FlexGen::Transformer
		include UML13
		def transform
	...
	def test_copyTransformer
		envIn = FlexGen::Environment.new
		envOut = FlexGen::Environment.new
