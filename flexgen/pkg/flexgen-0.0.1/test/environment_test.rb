...
class EnvironmentTest < Test::Unit::TestCase
	...
	class ClassSuperA < FlexGen::MetamodelBuilder::MMBase
	end
	
	class ClassSuperB < FlexGen::MetamodelBuilder::MMBase
	end
	
	class ClassC < FlexGen::MetamodelBuilder::MMMultiple(ClassSuperA, ClassSuperB)
	...
	def test_find
		...
		m2.name = "M2"
		m3 = "justAString"
		env = FlexGen::Environment.new << m1 << m2 << m3
