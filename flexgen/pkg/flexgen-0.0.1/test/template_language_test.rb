...
class TemplateContainerTest < Test::Unit::TestCase
  ...
  module CCodeMM
    class CArray < FlexGen::MetamodelBuilder::MMBase
      has_attr 'name'
      has_attr 'size', Integer
      has_attr 'type'
    end
    class PrimitiveInitValue < FlexGen::MetamodelBuilder::MMBase
  ...
  def test_with_model
    tc = FlexGen::TemplateLanguage::DirectoryTemplateContainer.new([MyMM, CCodeMM], OUTPUT_DIR)
