...
require 'flexgen/ecore/ecore_builder_methods'
...
class ModelBuilderTest < Test::Unit::TestCase
  ...
  module StatemachineMetamodel
    ...
    module Condition
      ...
      class Condition < FlexGen::MetamodelBuilder::MMBase
      end
    ...
    class State < FlexGen::MetamodelBuilder::MMBase
      has_attr 'name'
      has_attr 'kind', FlexGen::MetamodelBuilder::DataTypes::Enum.new([:START])
    end
  ...
  def test_statemachine
    result = FlexGen::ModelBuilder.build(StatemachineMetamodel) do 
  ...
  def test_dynamic
    ...
    result = FlexGen::ModelBuilder.build(StatemachineMetamodel, env) do
  ...
  module TestMetamodel
    ...
    class TestA < FlexGen::MetamodelBuilder::MMBase
    end
    class TestB < FlexGen::MetamodelBuilder::MMBase
    end
    class TestC < FlexGen::MetamodelBuilder::MMBase
    end
  ...
  def test_helper_names
    result = FlexGen::ModelBuilder.build(TestMetamodel) do
      testA "_a" do
        testB "_b"
      end
      testC :testB => "_a._b"
  ...
  def test_ecore
    result = FlexGen::ModelBuilder.build(FlexGen::ECore, nil, FlexGen::ECore::ECoreBuilderMethods) do
      ePackage "TestPackage1" do
        eClass "TestClass1" do
          eAttribute "attr1", :eType => FlexGen::ECore::EString
          eAttr "attr2", FlexGen::ECore::EInt
