...
require 'test/unit'
require 'flexgen/instantiator/default_xml_instantiator'
require 'flexgen/environment'
require 'flexgen/model_dumper'
...
module DefaultMM
	module MNS
		class Room < FlexGen::MetamodelBuilder::MMBase; end
	end
	class Person < FlexGen::MetamodelBuilder::MMBase; end
...
class XMLInstantiatorTest < Test::Unit::TestCase
	...
	include FlexGen::ModelDumper
	
	class MyInstantiator < FlexGen::Instantiator::DefaultXMLInstantiator
...
#		end
	...
	class PruneTestInstantiator < FlexGen::Instantiator::NodebasedXMLInstantiator
	...
	def test_default
		env = FlexGen::Environment.new
		inst = FlexGen::Instantiator::DefaultXMLInstantiator.new(env, EmptyMM, true)
		inst.instantiate_file(File.join(XML_DIR,"manual_testmodel.xml"))
