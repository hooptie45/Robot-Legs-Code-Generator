...
module UML13
   ...
   class Element < FlexGen::MetamodelBuilder::MMBase
   end
   ...
   class Classifier < FlexGen::MetamodelBuilder::MMMultiple(GeneralizableElement, Namespace)
   end
   ...
   class Association < FlexGen::MetamodelBuilder::MMMultiple(GeneralizableElement, Relationship)
   end
   ...
   class AssociationClass < FlexGen::MetamodelBuilder::MMMultiple(Class, Association)
   end
   ...
   class TemplateParameter < FlexGen::MetamodelBuilder::MMBase
   end

   class ElementResidence < FlexGen::MetamodelBuilder::MMBase
      has_attr 'visibility', UML13::VisibilityKind, :defaultValueLiteral => "public"
   end

   class Multiplicity < FlexGen::MetamodelBuilder::MMBase
   end

   class Expression < FlexGen::MetamodelBuilder::MMBase
   ...
   class MultiplicityRange < FlexGen::MetamodelBuilder::MMBase
   ...
   class EnumerationLiteral < FlexGen::MetamodelBuilder::MMBase
      has_attr 'name', String
   end
   ...
   class Collaboration < FlexGen::MetamodelBuilder::MMMultiple(GeneralizableElement, Namespace)
   end
   ...
   class LinkObject < FlexGen::MetamodelBuilder::MMMultiple(Object, Link)
   end
   ...
   class Call < FlexGen::MetamodelBuilder::MMBase
   end
   ...
   class ActionInstance < FlexGen::MetamodelBuilder::MMBase
   end
   ...
   class Package < FlexGen::MetamodelBuilder::MMMultiple(GeneralizableElement, Namespace)
   end

   class Model < Package
   end

   class Subsystem < FlexGen::MetamodelBuilder::MMMultiple(Classifier, Package)
      has_attr 'isInstantiable', Boolean
   end

   class ElementImport < FlexGen::MetamodelBuilder::MMBase
      has_attr 'visibility', UML13::VisibilityKind, :defaultValueLiteral => "public"
