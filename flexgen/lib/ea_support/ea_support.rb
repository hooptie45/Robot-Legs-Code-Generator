...
require 'flexgen/serializer/xmi11_serializer'
require 'flexgen/instantiator/xmi11_instantiator'
...
module EASupport
  ...
  def self.instantiateUML13FromXMI11(envUML, fileName, options={})
    envUMLEA = FlexGen::Environment.new
  ...
  def self.serializeUML13ToXMI11(envUML, fileName, options={})
    ...
    File.open(fileName, "w") do |f|
      xmiSer = FlexGen::Serializer::XMI11Serializer.new(f)
