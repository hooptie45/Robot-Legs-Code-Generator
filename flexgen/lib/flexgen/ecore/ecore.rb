...
module FlexGen
  ...
  # This is the ECore metamodel described using the FlexGen::MetamodelBuilder language.
  #
  ...
  module ECore
    ...
    class EObject < FlexGen::MetamodelBuilder::MMBase
    end
    
    class EModelElement < FlexGen::MetamodelBuilder::MMBase
    end
    
    class EAnnotation < FlexGen::MetamodelBuilder::MMMultiple(EModelElement, EObject)
    ...
    class EClassifier < ENamedElement
      ...
      module ClassModule
        def instanceClass_derived
          map = {"java.lang.string" => "String", "boolean" => "FlexGen::MetamodelBuilder::DataTypes::Boolean", "int" => "Integer"}
    ...
    class EStringToStringMapEntry < FlexGen::MetamodelBuilder::MMBase
      has_attr 'key', String
    ...
    EBoolean = EDataType.new(:name => "EBoolean", :instanceClassName => "FlexGen::MetamodelBuilder::DataTypes::Boolean")
